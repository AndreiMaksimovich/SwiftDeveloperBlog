...
func mapStyleOSMLiberty(sourceUrl: String) -> String {
    let fontsUrl =  MapAssets.pathFonts
    let spritesUrlString = MapAssets.pathSprites(mapStyle: .osmLiberty)
